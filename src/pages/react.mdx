...
My React blog posts are filed under the <Link to="/categories/react">React category</Link> page.

#### Workshops

I am giving React workshops, check the <Link to="/workshops">Workshops page</Link>

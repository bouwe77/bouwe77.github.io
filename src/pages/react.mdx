...
I am giving React workshops and training, check the <Link to="/categories/workshops">Workshops blogs</Link>
for more information or contact me on <a href="https://twitter.com/bouwe">Twitter</a>.

If you're Dutch, read my blog about my <Link to="/ik-geef-een-react-foundation-training">React Foundation training</Link>.
